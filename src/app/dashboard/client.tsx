        ...
        <div className="space-y-8">
            ...
            {activeTab === 'seeYouThere' && (
                <div className="bg-white rounded-lg shadow p-6">
                    <h2 className="text-2xl font-bold mb-4 text-[#333333]">People Who Clicked "See You There"</h2>
                    {seeYouSoonLoading ? (
                        <div className="flex justify-center items-center py-8">
                            <div className="animate-spin rounded-full h-10 w-10 border-t-2 border-b-2 border-[#7bb5d3]"></div>
                        </div>
                            ...
                            {seeYouSoonUsers.map((user) => (
                                <div key={user._id} className="p-4 bg-[#f9f9f9] rounded-lg shadow flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm text-[#5a95b5]">{user.organization}</div>
                                        <div className="flex flex-wrap gap-1 mt-1">
                                            {user.interests?.slice(0, 2).map((interest: string, i: number) => (
                                                <span key={i} className="px-2 py-0.5 bg-[#e6f2ff] text-[#7bb5d3] rounded-full text-xs">{interest}</span>
                                            ))}
                                        </div>
                                    </div>
                                </div>
            ...
            {activeTab === 'seeYouThereIWant' && (
                <div className="bg-white rounded-lg shadow p-6">
                    <h2 className="text-2xl font-bold mb-4 text-[#333333]">People I Want to Meet</h2>
